    ...
    <AppShell user={user}>
      <main className="workbench-shell">
        <section className="workbench-intro">
          <p className="workbench-eyebrow">Quality measurement</p>
          <h1>Calibration dashboard</h1>
          <p className="workbench-lede">Precision, recall, and benchmark metrics to tune ranking quality over time.</p>
        </section>
